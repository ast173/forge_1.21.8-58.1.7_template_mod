...
public class HelmetItemTemplate extends Item {
    public HelmetItemTemplate(ArmorMaterial material, String resourceID) {
    ...
    public boolean canApplyAtEnchantingTable(ItemStack stack, Holder<Enchantment> enchantment) {
        return enchantment.is(Enchantments.PROTECTION)
                ...
                || enchantment.is(Enchantments.RESPIRATION)
                || enchantment.is(Enchantments.AQUA_AFFINITY);
    }
}