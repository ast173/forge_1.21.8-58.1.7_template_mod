...
public class LeggingsItemTemplate extends Item {
    public LeggingsItemTemplate(ArmorMaterial material, String resourceID) {
    ...
    public boolean canApplyAtEnchantingTable(ItemStack stack, Holder<Enchantment> enchantment) {
        return enchantment.is(Enchantments.PROTECTION)
                ...
                || enchantment.is(Enchantments.SWIFT_SNEAK);
    }
}