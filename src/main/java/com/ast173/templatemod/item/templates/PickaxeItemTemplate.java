...
public class PickaxeItemTemplate extends Item {
    public PickaxeItemTemplate(ToolMaterial material, float damageModifier, String recourseID) {
        this(material, damageModifier, -2.8f, recourseID);
    }

    public PickaxeItemTemplate(ToolMaterial material, float damageModifier, float attackSpeedModifier, String resourceID) {
        super(new Properties()
                .pickaxe(material, damageModifier, attackSpeedModifier)
