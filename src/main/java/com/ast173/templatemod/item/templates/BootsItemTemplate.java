...
public class BootsItemTemplate extends Item {
    public BootsItemTemplate(ArmorMaterial material, String resourceID) {
    ...
    public boolean canApplyAtEnchantingTable(ItemStack stack, Holder<Enchantment> enchantment) {
        return enchantment.is(Enchantments.PROTECTION)
                ...
                || enchantment.is(Enchantments.DEPTH_STRIDER)
                || enchantment.is(Enchantments.FROST_WALKER)
                || enchantment.is(Enchantments.SOUL_SPEED);
    }
}